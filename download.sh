...
OUT_FILE=./app/checkpoints/wing.ckpt
wget -N $URL -O $OUT_FILE
URL=https://www.dropbox.com/s/91fth49gyb7xksk/celeba_lm_mean.npz?dl=0
OUT_FILE=./app/checkpoints/celeba_lm_mean.npz
wget -N $URL -O $OUT_FILE

URL=https://www.dropbox.com/s/96fmei6c93o8b8t/100000_nets_ema.ckpt?dl=0
mkdir -p ./app/checkpoints/celeba_hq
OUT_FILE=./app/checkpoints/celeba_hq/100000_nets_ema.ckpt
wget -N $URL -O $OUT_FILE

URL=https://www.dropbox.com/s/etwm810v25h42sn/100000_nets_ema.ckpt?dl=0
mkdir -p ./app/checkpoints/afhq
OUT_FILE=./app/checkpoints/afhq/100000_nets_ema.ckpt
wget -N $URL -O $OUT_FILE
